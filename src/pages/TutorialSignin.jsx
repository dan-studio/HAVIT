      ...
      <StyledDiv>
        ...
        >
          <Swiper
            ...
            modules={[Pagination, Mousewheel, Keyboard, Navigation]} // 페이지네이션, 마우스휠, 키보드 등을 사용하려면 모듈을 import해줘야 합니다.
            ...
            height={'1000px'}>
            <SwiperSlide style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', margin: 'auto', height: '650px' }}>
            ...
            <RiArrowLeftSLine ref={navigationPrevRef} size={30} />
            <RiArrowRightSLine ref={navigationNextRef} size={30} />
          </Swiper>
        </Modal>
      </StyledDiv>
    </div>
