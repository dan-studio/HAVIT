          ...
          <SwiperSlide>
            <StyledSwiper>
              <img
                ...
                style={{ height: "370px", transform:"translateX(-30px)" }}
              ></img>
            </StyledSwiper>
          </SwiperSlide>
          <SwiperSlide>
            <StyledSwiper>
              <img
                ...
                style={{ height: "335px" , transform:"translateX(-8px)"}}
              ></img>
            </StyledSwiper>
          </SwiperSlide>
          <SwiperSlide>
            <StyledSwiper>
              <img
                ...
                style={{ height: "345px" , transform:"translateX(-8px)"}}
              ></img>
            </StyledSwiper>
          </SwiperSlide>
          <SwiperSlide>
            <StyledSwiper>
              <img
                ...
                style={{ height: "350px", transform:"translateX(-8px)" }}
              ></img>
            </StyledSwiper>
          </SwiperSlide>
          <SwiperSlide>
            <StyledSwiper>
              <img
                ...
                style={{ height: "350px", transform:"translateX(-15px)"  }}
              ></img>
            </StyledSwiper>
          </SwiperSlide>
          <SwiperSlide>
